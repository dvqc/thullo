...
const description = `Simple board to start on a project. Each list can hold items (cards) that represent ideas or tasks. 
    ...
    <div className="description my-2">
      <div className="flex flex-col space-y-2">
        ...
        <div className="rounded-md border-2 p-2">
          <pre className="max-w-xs whitespace-pre-wrap">{description}</pre>
        </div>
      </div>
    </div>
  );
